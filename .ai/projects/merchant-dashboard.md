...
*Module patterns: `.cursor/skills/build-dashboard-module/SKILL.md` (Agent Skill). Safe refactor prompt: `.ai/prompts/safe-restructure.md`. Concept framing: `.ai/prompts/concept-guidelines.md`. **Visual system (tokens, components, layouts):** `design-guidelines/OVERVIEW.md`.*
