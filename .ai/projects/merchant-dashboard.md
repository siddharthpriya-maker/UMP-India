...
*Module patterns: `.ai/skills/build-dashboard-module.md`. Safe refactor prompt: `.ai/prompts/safe-restructure.md`. Concept framing: `.ai/prompts/concept-guidelines.md`.*
